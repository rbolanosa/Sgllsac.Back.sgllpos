...
exports.CompanySettingsModule = CompanySettingsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([company_settings_entity_1.CompanySettingsEntity]),
            axios_1.HttpModule,
        ],
        controllers: [company_settings_controller_1.CompanySettingsController],
        providers: [company_settings_service_1.CompanySettingsService, facturacion_adapter_1.FacturacionAdapter],
        exports: [company_settings_service_1.CompanySettingsService, facturacion_adapter_1.FacturacionAdapter],
    })

...
export class CreateInventoryAndBillingTables1737500000000 implements MigrationInterface {
  name = 'CreateInventoryAndBillingTables1737500000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Insert default "Consumidor Final" customer
    await queryRunner.query(`

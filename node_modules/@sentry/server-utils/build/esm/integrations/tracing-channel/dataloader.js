...
function subscribeConstruct() {
  diagnosticsChannel.tracingChannel(CHANNELS.DATALOADER_CONSTRUCT).start.subscribe((message) => {
    ...
    const wrapped = function(...args) {
      return startSpan(
        { ...makeSpanOptions(this, "batch"), links: this._batch?.spanLinks },

 ...
 * processor classes.
 */
export declare class SentryNestBullMQInstrumentation extends InstrumentationBase {
     ...
     */
    private _getProcessorFileInstrumentation;
    /**
     * Creates a wrapper function for the @Processor class decorator.
     */
    private _createWrapProcessor;
}
//# sourceMappingURL=sentry-nest-bullmq-instrumentation.d.ts.map
import { CustomTransform, InstrumentationConfig } from '@apm-js-collab/code-transformer';
type Diagnostics = {
...
export type { SerializedRegExp, SerializableInstrumentationConfig, AnyInstrumentationConfig, } from './instrumentation-serde';
